            ...
            <div class="mealTab">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <div class="meal-owltab owl-carousel">
                        ...
                        <div class="item">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-wednesday-tab" data-bs-toggle="pill" data-bs-target="#pills-wednesday" type="button" role="tab" aria-controls="pills-wednesday" aria-selected="true"><span class="day-selected"><i class="icon-checkmark"></i></span>Wednesday <span class="lead">14/ 03 </span></button>
                            </li>
                        </div>
                        <div class="item">
                            <li class="nav-item" role="presentation">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-wednesday" role="tabpanel" aria-labelledby="pills-wednesday-tab" tabindex="0">
                        <div class="wp-day-recipe-wrap">
