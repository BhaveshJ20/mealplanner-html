            ...
            <div class="plain-tabs">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-Profile-Settings-tab" data-bs-toggle="tab" data-bs-target="#nav-Profile-Settings" type="button" role="tab" aria-controls="nav-Profile-Settings" aria-selected="true">Profile Settings</button>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-Profile-Settings" role="tabpanel" aria-labelledby="nav-Profile-Settings-tab" tabindex="0">
