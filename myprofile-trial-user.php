            ...
            <div class="plain-tabs">
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link active" id="nav-Payments-tab" data-bs-toggle="tab" data-bs-target="#nav-Payments" type="button" role="tab" aria-controls="nav-Payments" aria-selected="true">Payments</button>
                        <button class="nav-link" id="nav-Membership-tab" data-bs-toggle="tab" data-bs-target="#nav-Membership" type="button" role="tab" aria-controls="nav-Membership" aria-selected="false">Membership</button>
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-Payments" role="tabpanel" aria-labelledby="nav-Payments-tab" tabindex="0">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-11">
                                    ...
                                    <div class="row justify-content-center my-md-5 my-4">
                                        <div class="col-lg-5">
                                            <p class="lead fw-medium text-center mb-4">You have not added any payment method so far</p>
                                            <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#ChoosePaymentMethodModal" data-bs-whatever="Add Payment Method">Add Payment Method</button>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table bg-white mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>-----</td>
                                                    <td>$ -.--</td>
                                                    <td><span class="bg-primary rounded-pill py-1 px-3 d-inline-block">----</span></td>
                                                    <td><a href="javascript:void(0);" class="text-gray"><i class="icon-download"></i> Downlod</a></td>
                                                </tr>
                                                <tr>
                                                    <th>2</th>
                                                    <td>--/--/----</td>
                    ...
                    <div class="tab-pane fade" id="nav-Membership" role="tabpanel" aria-labelledby="nav-Membership-tab" tabindex="0">
                        <div class="membership-details p-md-5 pb-md-4 p-sm-4 py-3">
                            <div class="row justify-content-center">
                                <div class="col-md-11">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="card-mini-box min-h-100 p-4 pb-2">
                                                <div class="title mb-4">
                                                    <h2 class="lead fw-bold">Latest Payment</h2>
                                                    <hr class="text-gray my-3"/>
                                                </div>
                                                <div class="d-sm-flex align-items-center justify-content-between">
                                                    <p class="lead text-gray fw-medium mb-4">Payment date</p>
                                                    <p class="lead text-dark text-sm-end fw-medium mb-4">March 16 , 2023</p>
                                                </div>
                                                <div class="d-sm-flex align-items-center justify-content-between">
                                                    <p class="lead text-gray fw-medium mb-4">Membership Plan</p>
                                                    <p class="lead text-dark text-sm-end fw-medium mb-4">Monthly</p>
                                                </div>
                                                <div class="d-sm-flex align-items-center justify-content-between">
                                                    <p class="lead text-gray fw-medium mb-4">Payment method</p>
                                                    <p class="lead text-dark text-sm-end fw-medium mb-4"><img src="assets/images/Mastercard.svg" width="41" height="26" class="d-inline-block align-text-top me-2" alt=""/>Master card ****0809</p>
                                                </div>
                                                <div class="d-sm-flex align-items-center justify-content-between">
                                                    <p class="lead text-gray fw-medium mb-4">Amount paid</p>
                                                    <p class="lead text-dark text-sm-end fw-medium mb-4">€ 7.99</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="card-mini-box min-h-100 p-4">
                                                <div class="title mb-4">
                                                    <h2 class="lead fw-bold">Next Payment</h2>
                                                    <hr class="text-gray my-3"/>
                                                </div>
                                                <div class="bg-extralight border rounded p-3 d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="icon-box-md bg-primary text-dark"><i class="icon-calendar"></i></a>
                                                    <div class="ms-3">
                                                        <p class="text-small text-gray mb-1">Due date</p>
                                                        <p class="text-small text-dark fw-bold">On April 16, 2023</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="membership-wrap">
                                        <div class="card-mini-box p-4 p-lg-5">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="card-mini-box p-0 mb-4 mb-lg-0">
                                                        <div class="membership-info p-3 p-lg-4">
                                                            ...
                                                            <div class="membership-btn">
                                                                <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#CancelSubscriptionModal" data-bs-whatever="Cancel">Cancel</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="card-mini-box p-0">
                                                        <div class="membership-info p-3 p-lg-4">
                                                            <div class="membership-header">
                                                                <div class="title mb-4 mb-lg-5">
                                                                    <h3 class="title-md fw-bold text-primary">12 Months</h3>
                                                                    <p class="lead text-gray fw-medium">Annually billing</p>
                                                                </div>
                                                                <div class="title mb-4">
                                                                    <h3 class="title-lg fw-bold">€ 5.99 <span class="lead fw-medium">/ per month</span></h3>
                                                                </div>
                                                            </div>
                                                            <div class="membership-list">
                                                                <p class="d-flex lead fw-medium my-4">
                                                            ...
                                                            <div class="membership-btn">
                                                                <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#ChooseSubscribeModal" data-bs-whatever="Choose Subscription">Choose Subscription</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="row justify-content-center w-100">
                        <div class="col-lg-8">                        
                            <form class="cmxform" id="AddMasterCardForm" method="post" action="">
                                ...
                                <div class="mb-4 position-relative">
                                    <input id="cnumber" type="tel" name="cnumber" class="form-control" placeholder="Credit Card Number" required />
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-4 position-relative">
                                            <input id="cvalidThru" type="tel" name="cvalidThru" class="form-control" placeholder="Valid Thru ( MM / YY )" maxlength="7" required />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-4 position-relative">
                                            <input id="cvv" type="tel" name="cvv" class="form-control" placeholder="CVV / CVC" maxlength="4" required />
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-flex flex-column align-items-center justify-content-center">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="title text-center mb-5">
                                <h1 class="title-sm fw-bold">Do you really want to cancel your subscription ?</h1>
                            </div>
                            <div class="icon-box-big bg-primary text-white mx-auto mb-5"><i class="icon-denied"></i></div>
                            <div class="d-sm-flex justify-content-sm-between justify-content-center">
                                <div class="text-center mb-4 mb-md-0"><button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#MyProfileThankYouModal" data-bs-whatever="Yes">Yes</button></div>
